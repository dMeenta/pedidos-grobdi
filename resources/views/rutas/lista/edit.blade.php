...
<div class="card">
    ...
    <form action="{{ route('lista.update',$lista->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label class="form-label" for="name">¿Recuperación?</label>
                <select class="form-control @error('recovery') is-invalid @enderror" name="recovery">
                    <option selected disabled>Seleccione una opción</option>
                    <option value="1" {{ $lista->recovery ? 'selected' : '' }}>Si</option>
                    <option value="0" {{ $lista->recovery ? '' : 'selected' }}>No</option>
                </select>
            </div>
            <div class="form-group">
