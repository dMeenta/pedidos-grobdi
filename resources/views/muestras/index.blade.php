                ...
                <tbody>
                    @foreach ($muestras as $index => $muestra)
                        <tr id="muestra_{{ $muestra->id }}">
                                    ...
                                    @php
                                        $approvalConfigs = [
                                            ...
                                            'jefe-operaciones' => [
                                                ...
                                                'canApprove' =>
                                                    in_array($role, ['admin', 'jefe-operaciones']) && $muestra->state,
                                            ],
                                        ];
                                    @endphp
                            ...
                            <td>
                                <div>
                                    <button class="btn btn-success btn-sm btn-show-details w-100"
                                    ...
                                    @can('muestras.disable')
                                        <button class="btn btn-danger btn-sm btn-show-delete w-100"
