        ...
        <form action="{{ $muestra ? route('muestras.update', $muestra->id) : route('muestras.store') }}" method="POST"
            ...
            <div class="form-group">
                ...
                @if ($errors->has('nombre_muestra'))
                    <div class="text-success"><i
                            class="fas fa-skull-crossbones mr-2"></i>{{ $errors->first('nombre_muestra') }}</div>
                @endif
            </div>
            ...
            <div class="row">
                    ...
                    <select name="clasificacion_id" id="clasificacion_id" class="custom-select" required>
                        ...
                        @foreach ($clasificaciones as $clasificacion)
                            <option value="{{ $clasificacion->id }}"
                                {{ old('clasificacion_id', $muestra->clasificacion_id ?? '') == $clasificacion->id ? 'selected' : '' }}>
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select name="tipo_frasco" id="tipo_frasco" class="custom-select" required>
                        ...
                        <option value="frasco original"
                            {{ old('tipo_frasco', $muestra->tipo_frasco ?? '') == 'Frasco Original' ? 'selected' : '' }}>
                            Frasco Original</option>
                        <option value="frasco muestra"
                            {{ old('tipo_frasco', $muestra->tipo_frasco ?? '') == 'Frasco Muestra' ? 'selected' : '' }}>
            ...
            <div class="row">
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <input type="text" name="unidad_de_medida" id="unidad_de_medida" class="form-control" readonly
                        required
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select name="clasificacion_presentacion_id" id="clasificacion_presentacion_id" class="custom-select"
                        required
                        {{ old('tipo_frasco', $muestra->tipo_frasco ?? '') == 'Frasco Muestra' ? 'disabled' : '' }}>
                        @if (
                            $muestra &&
