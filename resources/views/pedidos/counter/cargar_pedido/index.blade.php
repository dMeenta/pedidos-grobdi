                                    ...
                                    <form action="{{ route('cargarpedidos.downloadWord') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input custom-control-input-danger"
                                                        type="radio" name="turno" id="turno0" value="0" checked>
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input custom-control-input-danger"
                                                        type="radio" name="turno" id="turno1" value="1">
                                ...
                                <tr>
                                        ...
                                        @if ($canUpdateTurno)
                                            <form action="{{ route('cargarpedidos.actualizarTurno', $arr->id) }}"
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select-sm"
                                                    name="turno" onchange="this.form.submit()">
                                    ...
                                    @if ($showOptionsColumn)
                                        <td>
                                            ...
                                            @endif
                                            @if ($canViewPedido)
                                                <button type="button" class="btn btn-info btn-show-order w-100 my-2"
                                                    data-id="{{ $arr->id }}"
                                            ...
                                            @if ($canEditPedido)
                                                <a class="btn btn-primary w-100"
                                                    href="{{ route('cargarpedidos.edit', $arr->id) }}"><i
