...
<script>
    ...
    let amountSpentByDoctorGroupedByMonthChart = createChart(
        '#amountSpentByDoctorGroupedByMonthChart',
        monthLabels,
        Object.values(initialValues.amountSpentByDoctorGroupedByMonth).map(Number),
        'Monto de Inversión del Doctor',
    ...
    let amountSpentByDoctorGroupedByTipoChart = createChart('#amountSpentByDoctorGroupedByTipoChart', initialValues.amountSpentByDoctorGroupedByTipo.map(i => i.tipo), initialValues.amountSpentByDoctorGroupedByTipo.map(i => i.total_sub_total), 'Monto de Inversión del Doctor',
        'bar');
    let topMostConsumedProductsInTheMonthByDoctorChart = createChart('#topMostConsumedProductsInTheMonthByDoctorChart', initialValues.topMostConsumedProductsInTheMonthByDoctor.map(i => i.articulo), initialValues.topMostConsumedProductsInTheMonthByDoctor.map(i => i.total_cantidad), 'Cantidad comprada',
        'bar', );
</script>
<script>
    $(document).ready(() => {
