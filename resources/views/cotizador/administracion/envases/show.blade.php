<!-- Modal para mostrar detalles del envase -->
<div class="modal fade" id="detalleModalenvase{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="detalleLabel{{ $item->id }}" aria-hidden="true">
        ...
        <div class="modal-content" style="border-radius: 12px;">
            <div class="modal-header text-white" style="background-color: rgba(255, 111, 128, 0.93);">
                <h5 class="modal-title" id="detalleLabel{{ $item->id }}">
                    <i class="fas fa-info-circle mr-2"></i>Detalles del Envase
                </h5>
            ...
            <div class="modal-body" style="background-color: #f8f9fa; border-radius: 12px;">
                <div class="row">
                    ...
                    <div class="col-md-6" style="overflow-wrap: break-word; white-space: normal;">
                        <p><strong style="color:rgb(224, 61, 80);">Estado:</strong><span class="badge {{ $item->articulo->estado === 'activo' ? 'bg-success' : 'bg-danger' }}" style="color: white; padding: 5px;">
