...
<div class="modal fade" id="detalleModalmaterial{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="detalleLabel{{ $item->id }}" aria-hidden="true">
            ...
            <div class="modal-body" style="background-color: #f8f9fa; border-radius: 12px;">
                <div class="row">
                    <div class="col-md-6" style="overflow-wrap: break-word; white-space: normal;">
                        ...
                        <p><strong style="color:rgb(224, 61, 80);">Tipo:</strong> {{ ucfirst($item->tipo) }}</p>
